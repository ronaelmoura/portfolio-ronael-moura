...
const projects = [
  ...
  },
  {
    ...
    category: 'opensource',
    type: 'Open source · Biblioteca',
    description: 'Biblioteca em TypeScript, com código aberto no GitHub, que resolve um edge case real do Multer ao receber arquivos exatamente no limite configurado. O repositório documenta a reprodução do bug e a correção.',
